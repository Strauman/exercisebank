%% exercisebank v0.0.3b42 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.3 (2018/04/03) build 42
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.3{\\[-0.5em]\footnotesize(build 42)}}}
