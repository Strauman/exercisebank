%% exercisebank v0.0.4b44 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.4 (2018/04/03) build 44
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.4{\\[-0.5em]\footnotesize(build 44)}}}
