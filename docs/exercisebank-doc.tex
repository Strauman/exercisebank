%% exercisebank v0.0.3b40 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.3 (2018/04/03) build 40
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.3{\\[-0.5em]\footnotesize(build 40)}}}
