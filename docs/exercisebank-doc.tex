%% exercisebank v0.0.5b46 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.5 (2018/04/03) build 46
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.5{\\[-0.5em]\footnotesize(build 46)}}}
