%% exercisebank v0.1.0b50 - 2018/04/06
%% The LaTeX package exercisebank - version v0.1.0 (2018/04/06) build 50
%% #PACKAGE.sty
%% -------------------------------------------------------------------------------------------
...
\title{{exercisebank - manual\\ v0.1.0{\\[-0.5em]\footnotesize(build 50)}}}
...
\begin{tabularx}{\textwidth}{llX}
  ...
  \end{itemize}\\
  v0.1.0&2018/04/06&\begin{itemize}
