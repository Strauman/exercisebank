%% exercisebank v0.0.3b39 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.3 (2018/04/03) build 39
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.3{\\[-0.5em]\footnotesize(build 39)}}}
\author{Andreas Strauman}
\begin{document}
\maketitle
 
If you found any bugs or want new functionality, to contribute, view the commented source, get latest version of this package or get in touch with me, you can do all of that at \url{#GITHUB}
\tableofcontents
\clearpage
\section{Motivation}
...
\begin{tabularx}{\textwidth}{llX}
  ...
  \end{itemize}\\
  v0.0.3b39&2018/04/03&\begin{itemize}
