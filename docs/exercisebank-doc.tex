%% exercisebank v0.0.2b37 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.2 (2018/04/03) build 37
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.2{\\[-0.5em]\footnotesize(build 37)}}}
