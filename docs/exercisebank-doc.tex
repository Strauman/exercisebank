%% exercisebank v0.1.0-betab53 - 2018/04/06
%% The LaTeX package exercisebank - version v0.1.0-beta (2018/04/06) build 53
%% #PACKAGE.sty
%% -------------------------------------------------------------------------------------------
...
\title{{exercisebank - manual\\ v0.1.0-beta{\\[-0.5em]\footnotesize(build 53)}}}
...
\begin{tabularx}{\textwidth}{llX}
  ...
  \end{itemize}\\
  v0.1.0-beta&2018/04/06&\begin{itemize}
    \item \begin{marker}Backward incompability from v0.0.5:Removed default exercise directory! \end{marker} Use \dac{exercisebanksetup}\brackets{exercise directory=exercises} if you used the package before 2018/04/06!
