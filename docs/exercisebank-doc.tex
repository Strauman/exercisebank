%% exercisebank v0.0.6b48 - 2018/04/05
%% The LaTeX package exercisebank - version v0.0.6 (2018/04/05) build 48
%% #PACKAGE.sty
%% -------------------------------------------------------------------------------------------
...
\title{{exercisebank - manual\\ v0.0.6{\\[-0.5em]\footnotesize(build 48)}}}
