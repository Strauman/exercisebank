%% exercisebank v0.0.2b35 - 2018/04/03
%% The LaTeX package exercisebank - version v0.0.2 (2018/04/03) build 35
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.2{\\[-0.5em]\footnotesize(build 35)}}}
