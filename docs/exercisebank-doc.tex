%% exercisebank v0.1.1b56 - 2018/04/12
%% The LaTeX package exercisebank - version v0.1.1 (2018/04/12) build 56
%% #PACKAGE.sty
%% -------------------------------------------------------------------------------------------
...
\title{{exercisebank - manual\\ v0.1.1{\\[-0.5em]\footnotesize(build 56)}}}
