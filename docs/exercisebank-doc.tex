%% exercisebank v0.1.0-betab51 - 2018/04/06
%% The LaTeX package exercisebank - version v0.1.0-beta (2018/04/06) build 51
%% #PACKAGE.sty
%% -------------------------------------------------------------------------------------------
...
\title{{exercisebank - manual\\ v0.1.0-beta{\\[-0.5em]\footnotesize(build 51)}}}
