%% exercisebank v0.0.2b28 - 2018/04/02
%% The LaTeX package exercisebank - version v0.0.2 (2018/04/02) build 28
%% exercisebank.sty
%% -------------------------------------------------------------------------------------------
...
\title{{Handin - manual\\ v0.0.2{\\[-0.5em]\footnotesize(build 28)}}}
