%% exercisebank v0.3.1-experimentalb138 - 2019/04/17
...
\title{{exercisebank - manual\\ v0.3.1-experimental{\\[-0.5em]\footnotesize(build 138)}}}
...
\updated{v0.3.1-experimental\\@@DATE }
...
\newversion{v0.3.1-experimental 2019/04/17}
    \change{Made \dac\exercisenote long (can now deal with multiple lines).}
    \change{Fixed bug where \dac\ShowFilenames would crash when filename has underscore.}
\chlogtable
