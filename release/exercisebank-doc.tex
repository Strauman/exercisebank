%% exercisebank v0.2.3-prereleaseb119 - 2019/01/30
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 119)}}}
...
\defnew{v0.2.3-prerelease\\2019/01/30 }
...
\updated{v0.2.3-prerelease\\2019/01/30 }
...
\newversion{v0.2.3-prerelease 2019/01/30}
