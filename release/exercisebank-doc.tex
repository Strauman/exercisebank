%% exercisebank v0.2.3-prereleaseb130 - 2019/02/24
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 130)}}}
...
\defnew{v0.2.3-prerelease\\2019/02/24 }
...
\updated{v0.2.3-prerelease\\2019/02/24 }
...
\newversion{v0.2.3-prerelease 2019/02/24}
