%% exercisebank v0.2.3-prereleaseb118 - 2019/01/28
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 118)}}}
...
\defnew{v0.2.3-prerelease\\2019/01/28 }
...
\updated{v0.2.3-prerelease\\2019/01/28 }
...
\newversion{v0.2.3-prerelease 2019/01/28}
