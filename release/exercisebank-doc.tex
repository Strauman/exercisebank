%% exercisebank v0.2.3-prereleaseb115 - 2018/12/08
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 115)}}}
...
\defnew{v0.2.3-prerelease\\2018/12/08 }
...
\updated{v0.2.3-prerelease\\2018/12/08 }
...
\newversion{v0.2.3-prerelease 2018/12/08}
