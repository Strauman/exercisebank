%% exercisebank v0.2.1-prereleaseb87 - 2018/09/05
...
\title{{exercisebank - manual\\ v0.2.1-prerelease{\\[-0.5em]\footnotesize(build 87)}}}
...
\updated{v0.2.1-prerelease\\2018/09/05 }
...
\defnew{v0.2.1-prerelease\\2018/09/05 }
This command will generate multiple sets:
\begin{dispListing}
...
\newversion{v0.2.1-prerelease 2018/09/05}
