%% exercisebank v0.1.3-prereleaseb69 - 2018/04/19
...
\title{{exercisebank - manual\\ v0.1.3-prerelease{\\[-0.5em]\footnotesize(build 69)}}}
...
\updated{v0.1.3-prerelease\\2018/04/19 }
...
\end{itemize}\\
  ...
  \end{itemize}\\
  v0.1.3-prerelease&2018/04/19&\begin{itemize}
