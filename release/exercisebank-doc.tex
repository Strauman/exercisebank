%% exercisebank v0.2.1-prereleaseb95 - 2018/09/18
...
\title{{exercisebank - manual\\ v0.2.1-prerelease{\\[-0.5em]\footnotesize(build 95)}}}
...
\defnew{v0.2.1-prerelease\\2018/09/18 }
...
\updated{v0.2.1-prerelease\\2018/09/18 }
...
\newversion{v0.2.1-prerelease 2018/09/18}
