%% exercisebank v0.2.3-prereleaseb106 - 2018/11/04
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 106)}}}
...
\defnew{v0.2.3-prerelease\\2018/11/04 }
...
\end{dispListing}
 It has also been pointed out that some characters sets, e.g. Chinese,
 characters would not work with this exact method. The work around for this
 is currently to set the storing macros, as below
\begin{dispListing}
\makeatletter
\gdef\exbank@opt@problemHeader{%
 \normalfont\Large\bfseries TRANSLATION~\theproblemcounter%
}
\gdef\exbank@opt@solutionHeader{%
 \large{\textbf{TRANSLATION}}%
}
\makeatother
\end{dispListing}
 (replace \texttt{TRANSLATION} with your translation)
\end{docCommand}
...
\updated{v0.2.3-prerelease\\2018/11/04 }
...
\newversion{v0.2.3-prerelease 2018/11/04}
