%% exercisebank v0.2.3-prereleaseb127 - 2019/02/16
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 127)}}}
...
\defnew{v0.2.3-prerelease\\2019/02/16 }
...
\updated{v0.2.3-prerelease\\2019/02/16 }
...
\newversion{v0.2.3-prerelease 2019/02/16}
