%% exercisebank v0.2.1-prereleaseb93 - 2018/09/10
...
\title{{exercisebank - manual\\ v0.2.1-prerelease{\\[-0.5em]\footnotesize(build 93)}}}
...
\updated{v0.2.1-prerelease\\2018/09/10 }
...
\defnew{v0.2.1-prerelease\\2018/09/10 }
This command will generate multiple sets:
\begin{dispListing}
...
\newversion{v0.2.1-prerelease 2018/09/10}
