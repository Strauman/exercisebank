%% exercisebank v0.2.1-prereleaseb77 - 2018/08/26
...
\providecommand\thankyous{}
\providecommand\@thankyous@content{}
...
\title{{exercisebank - manual\\ v0.2.1-prerelease{\\[-0.5em]\footnotesize(build 77)}}}
...
If you feel up for it, you can always find the latest development version online, and I always need people to test -- it saves me a lot of time! \if\thankyous\relax\else\footxt{Special thanks to these contributors: \thankyous}\fi
\tableofcontents
\clearpage
\section{Motivation}
...
\defnew{v0.2.1-prerelease\\2018/08/26 }
This command will generate multiple sets:
\begin{dispListing}
...
\newversion{v0.2.1-prerelease 2018/08/26}
    ...
    \change[\gh{thorstengrothe}]{A special thanks to github user \texttt{@thorstengrothe} for doing testing and giving feedback on new features!}
    \thankyou{\gh{thorstengrothe} -- \ghURL{thorstengrothe}}
\chlogtable
 \end{document}
