%% exercisebank v0.2.1-prereleaseb79 - 2018/08/27
...
\title{{exercisebank - manual\\ v0.2.1-prerelease{\\[-0.5em]\footnotesize(build 79)}}}
...
\if\thankyous\relax\else\footxt{People who helped test and make this package better (github users): \testers}\fi
\tableofcontents
\clearpage
\section{Motivation}
...
\defnew{v0.2.1-prerelease\\2018/08/27 }
This command will generate multiple sets:
\begin{dispListing}
...
\newversion{v0.2.1-prerelease 2018/08/27}
