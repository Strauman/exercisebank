%% exercisebank v0.2.1-prereleaseb88 - 2018/09/06
...
\title{{exercisebank - manual\\ v0.2.1-prerelease{\\[-0.5em]\footnotesize(build 88)}}}
...
\updated{v0.2.1-prerelease\\2018/09/06 }
...
\defnew{v0.2.1-prerelease\\2018/09/06 }
This command will generate multiple sets:
\begin{dispListing}
...
\newversion{v0.2.1-prerelease 2018/09/06}
