%% exercisebank v0.2.3-prereleaseb108 - 2018/11/11
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 108)}}}
...
\defnew{v0.2.3-prerelease\\2018/11/11 }
...
\updated{v0.2.3-prerelease\\2018/11/11 }
...
\newversion{v0.2.3-prerelease 2018/11/11}
