%% exercisebank v0.2.2-prereleaseb96 - 2018/10/03
...
\title{{exercisebank - manual\\ v0.2.2-prerelease{\\[-0.5em]\footnotesize(build 96)}}}
...
\updated{v0.2.2-prerelease\\2018/10/03 }
This command will generate multiple sets:
\begin{dispListing}
...
\newversion{v0.2.2-prerelease 2018/10/03}
