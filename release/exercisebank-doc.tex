%% exercisebank v0.2.3-prereleaseb116 - 2018/12/18
%% The LaTeX package exercisebank - version v0.2.3-prerelease (2018/12/18) build 116
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 116)}}}
...
\defnew{v0.2.3-prerelease\\2018/12/18 }
...
\updated{v0.2.3-prerelease\\2018/12/18 }
...
\newversion{v0.2.3-prerelease 2018/12/18}
