%% exercisebank v0.2.3-prereleaseb117 - 2019/01/27
...
\title{{exercisebank - manual\\ v0.2.3-prerelease{\\[-0.5em]\footnotesize(build 117)}}}
...
\defnew{v0.2.3-prerelease\\2019/01/27 }
...
\updated{v0.2.3-prerelease\\2019/01/27 }
...
\newversion{v0.2.3-prerelease 2019/01/27}
