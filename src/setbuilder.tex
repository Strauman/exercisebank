...
\let\emptyList\exb@emptyList
\let\exb@tagList\exb@emptyListg
%
\gdef\ifppMode#1{
...
%   \isin{\exb@currentTag}{\exb@tagList}{}{\xdef\DisplayProblem{\F@}}%
% \fi
...
\exb@isin{\exb@currentTag}{\exb@tagList}{}{\global\exb@opthidestrue}
\fi
}
...
%:=\DeclareExerciseCommand{\dac{command}}{actions}
