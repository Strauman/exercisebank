...
%\Trigger\BeginBuildset:Triggers right before a set has begun building (not if \dac{sprite} is used). You might want to put your set-header here
%\Trigger\EndBuildset:Triggers when a set has stopped building (not if \dac{sprite} is used)
