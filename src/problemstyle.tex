...
\At\VeryBeginProblem{
	...
	\vspace*{\pMarginAbove}
		\hskip\pMarginLeft{\exbank@opt@problemHeader}
	\vspace*{\pMarginBelow}
}
\At\EndProblem{
\tighten@paragraph
...
\At\VeryBeginPartproblem{%
	...
	\fi%
	\par\@atMargin{{\exbank@opt@partProblemHeader}}{\ppMargin}\ignorespaces%
}
\At\EndPartproblem{
...
\At\BeginSolution{\hfill\break\vspace*{1em}{\exbank@opt@solutionHeader}}
\At\EndSolution{}
